<div class="container my-4">
    ...
    @else
        <div class="card p-4 shadow-sm">
            ...
            <div class="row">
                <div class="col-12 ads_image">
                    <img src="{{ $ads?->image() }}" alt="Ad Banner">
                </div>
        ...
        @if ($ads->status == 'pending_approval')
            <div class="action-wrapper d-flex justify-content-center gap-2 py-4">
                <button class="btn btn-success confirmation"
                    data-url="{{ route('admin.ads.approve', ['id' => $ads->id]) }}"
                    data-text="Are you sure you want to approve this ad?">
                    Approve
                </button>
                <button class="btn btn-danger confirmation"
                    data-url="{{ route('admin.ads.reject', ['id' => $ads->id]) }}"
